...
subplot(1,3,3); plot(outcomPred{100}-1)
figure; plot((choices == stim))
...
outcomPred = mean(probSeq,1);

if strcmp(probFlag,'prob')
 bestPolicy = randsample(length(outcomPred),1,true,softmax(outcomPred)./sum(softmax(outcomPred)));
else
